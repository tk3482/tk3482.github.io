(function(){
	...
	var data = mabi_st.getAttribute("data-st");
	...
	document.write('<iframe style="width:180px;height:280px;margin:0px;padding:0px;" width="180" height="280" allowtransparency="true" scrolling="no" frameborder="0" border="0" src="https://tk3482.github.io/mabi_st/st.html?' + data + '"></iframe>');
